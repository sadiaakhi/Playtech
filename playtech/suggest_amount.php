    ...
    <div class="col-md-12">
      <div class="card bg-danger">
        <div class="card-body">
          ...
          <br>
          <h2 class="text-center mb-0 font-weight-semibold text-light ">Please tell us your budget</h2>
          <h3 class="text-center mb-0 font-weight-semibold text-light">we will suggest you components that will be best for you</h3>
          <br><br>
          <form method="post" action="suggestion_result.php" style="margin-top: 50px;">
            <label>Enter Amount:
              <input type="price" name="price" id="textfield2" />
            </label><br><br>
            
              <input class="btn btn-warning" type="submit" name="button" id="button" value="Submit"  >
              <a class="btn btn-warning btn-lg" href="product_1.php" role="button">Go Back</a>
