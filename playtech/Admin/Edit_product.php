                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th class="text-danger"><b>Catagory</b></th>
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td> <img src="../upload/<?php echo $row["image"]; ?>" height="50" width ="50" title="<?php echo $row['image']; ?>"> </td>
                                <td><a class="bi bi-arrow-repeat" href="updateproduct.php?id=<?php echo $row['code'];?>" role="button">Update</a></td>
                                <td><a class="bi bi-arrow-repeat" href="Edit_product.php?id=<?php echo $row['code'];?>" role="button">Delete</a></td>
                            </tr>
                            <?php endforeach; ?>
                    </tbody>
