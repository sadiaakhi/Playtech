...
<head>
    <title>suggesting results based on budget</title>
        ...
        $query = "
                ...
                FROM (
                    ...
                    LEFT JOIN product p2
                        ON p1.catagory = p2.catagory AND p1.price < p2.price
                    WHERE p1.price <= $budget AND p2.code IS NULL
                ...
                ORDER BY (
                    ...
                    FROM (
                        ...
                        LEFT JOIN product p2
                            ON p1.catagory = p2.catagory AND p1.price < p2.price
                        WHERE p1.price <= $budget AND p2.code IS NULL
                    ) AS selected_products_sum
                    WHERE selected_products_sum.catagory = selected_products.catagory
                )";
        ...
        <div class="card-deck">
            <div class="card border-danger bg-transparent h-100">
                <div class="card-body d-flex flex-column">
                    <div class="card-img-actions flex-grow-1">
